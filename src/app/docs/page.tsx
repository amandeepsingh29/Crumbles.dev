...
export default function DocsPage() {
  return <BusinessPage eyebrow="07 / Documentation" title="Build agents on a layer you can inspect." intro="The public product documentation is being assembled around the Tracey and Atlas platform APIs. Request access to receive the current integration notes and architecture brief." sections={[
