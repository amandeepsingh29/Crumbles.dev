...
export const metadata: Metadata = {
  ...
  description: 'Join Crumbles to build reliable AI SRE and knowledge infrastructure for production agents.',
  alternates: { canonical: '/careers' },
  openGraph: { title: 'Careers | Crumbles', description: 'Join Crumbles to build reliable AI SRE and knowledge infrastructure for production agents.', url: '/careers', images: ['/opengraph-image'] },
};
    ...
    <main className="relative z-10 min-h-screen bg-[#f4f1e8] px-6 pb-32 pt-32 dark:bg-gray-950">
      <div className="mx-auto max-w-7xl">
        <header className="grid gap-10 border-b border-gray-900/15 pb-16 dark:border-white/15 lg:grid-cols-[1fr_0.7fr] lg:items-end">
          <div>
            <p className="mb-6 text-xs font-black uppercase tracking-[0.3em] text-emerald-700 dark:text-emerald-300">04 / Build agent infrastructure</p>
            <h1 className="max-w-4xl text-6xl font-black leading-[0.9] tracking-[-0.06em] text-gray-950 dark:text-white md:text-8xl">Build the <span className="text-emerald-600 dark:text-emerald-300">agent stack.</span></h1>
          </div>
