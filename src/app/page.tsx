      ...
      <section className="relative px-6 pb-20 pt-32 md:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div>
              <p className="mb-6 text-sm font-black uppercase tracking-[0.22em] text-sky-600 dark:text-sky-300">Crumbles / Core systems</p>
            ...
            <div className="max-w-md lg:justify-self-end">
              <p className="text-xl font-medium leading-relaxed text-gray-700 dark:text-gray-300">Crumbles gives agent teams the control plane and knowledge layer they need to run reliably in production.</p>
      ...
      <footer className="bg-gray-950 px-6 pb-8 pt-20 text-white">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 border-b border-white/15 pb-16 md:grid-cols-[1.4fr_0.6fr_0.6fr_1fr]">
            <div>
              <h2 className="text-3xl font-black">Crumbles</h2>
