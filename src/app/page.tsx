        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative overflow-hidden rounded-[2rem] bg-gray-950 p-8 text-white shadow-2xl dark:bg-white dark:text-gray-950 md:p-12">
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="ml-8 border-l-2 border-violet-400 pl-5"><p className="font-mono text-xs text-gray-400 dark:text-gray-500">PLATFORM</p><p className="mt-2 text-xl font-black">Tracey + Atlas</p></div>
      ...
      <footer className="bg-gray-950 px-6 pb-8 pt-20 text-white">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 border-b border-white/15 pb-16 md:grid-cols-[1.2fr_0.7fr_0.7fr_1fr_0.8fr]">
            ...
            <div><p className="text-xs font-black uppercase tracking-[0.2em] text-gray-500">Products</p><p className="mt-5 text-sm leading-relaxed text-gray-400">Tracey, Atlas, Clara, and Riley.</p></div>
